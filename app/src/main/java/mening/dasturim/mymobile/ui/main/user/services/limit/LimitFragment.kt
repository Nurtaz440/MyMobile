...
class LimitFragment : BaseFragment<FragmentInternetPocketsBinding, ProfiteVM>() {
    private lateinit var firebaseFirestore: FirebaseFirestore
    lateinit var profiteAdapter: LimitFragmentVP
    override fun onBound() {
        setUp()
    }
    fun setUp(){
        ViewUtils.fadeIn(binding.progressBar)
        profiteAdapter= LimitFragmentVP(requireFragmentManager(),requireActivity().lifecycle)
                                    ...
                                    if (p0.isSuccessful) {
                                        ...
                                        p0.result?.let {
                                            ...
                                            val list: List<String> =
                                                it.get("collections2") as ArrayList<String>
