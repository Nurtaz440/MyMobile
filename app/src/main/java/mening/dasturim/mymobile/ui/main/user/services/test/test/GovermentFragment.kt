package mening.dasturim.mymobile.ui.main.user.services.test.test
...
class GovermentFragment: BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("davlat test markazi")
