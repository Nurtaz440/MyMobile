package mening.dasturim.mymobile.ui.main.user.tariff.free
...
class FreeFragment : BaseFragment<FragmentInternetBinding, BestFragmentVM>() {
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Tariflar").collection("Erkin muloqot")
