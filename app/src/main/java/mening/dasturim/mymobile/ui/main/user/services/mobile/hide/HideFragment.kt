package mening.dasturim.mymobile.ui.main.user.services.mobile.hide
...
class HideFragment : BaseFragment<FragmentInternetBinding, HideFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Raqamni yashirish")
    ...
    override val vm: HideFragmentVM
        get() = ViewModelProvider(this).get(HideFragmentVM::class.java)
}