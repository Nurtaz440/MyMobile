package mening.dasturim.mymobile.ui.main.user.services.call.lux
...
class LuxFragment: BaseFragment<FragmentInternetBinding, LuxFragmentVM>() {
...
fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Beeline VISA")
    ...
    override val vm: LuxFragmentVM
        get() = ViewModelProvider(this).get(LuxFragmentVM::class.java)
}