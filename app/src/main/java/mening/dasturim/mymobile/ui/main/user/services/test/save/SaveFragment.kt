package mening.dasturim.mymobile.ui.main.user.services.test.save
...
class SaveFragment: BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("chaqiruvni saqlash")
