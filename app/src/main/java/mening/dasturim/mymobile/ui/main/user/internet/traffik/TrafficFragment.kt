package mening.dasturim.mymobile.ui.main.user.internet.traffik
...
class TrafficFragment : BaseFragment<FragmentInternetBinding, TrafficFragmentVM>() {
    ...
    override val vm: TrafficFragmentVM
    get() = ViewModelProvider(this).get(TrafficFragmentVM::class.java)
