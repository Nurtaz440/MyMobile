package mening.dasturim.mymobile.ui.main.user.services.mobile.solution
...
class SolutionFragment : BaseFragment<FragmentInternetBinding, SolutionFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Real Solutions")
    ...
    override val vm: SolutionFragmentVM
        get() = ViewModelProvider(this).get(SolutionFragmentVM::class.java)
}