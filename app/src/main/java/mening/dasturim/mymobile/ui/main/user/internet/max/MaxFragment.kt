package mening.dasturim.mymobile.ui.main.user.internet.max
...
class MaxFragment : BaseFragment<FragmentInternetBinding, MaxFragmentVM>() {
    ...
    override val vm: MaxFragmentVM
    get() = ViewModelProvider(this).get(MaxFragmentVM::class.java)
