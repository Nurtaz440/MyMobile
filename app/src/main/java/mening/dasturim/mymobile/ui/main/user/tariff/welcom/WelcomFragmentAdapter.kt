...
class WelcomFragmentAdapter(val context: Context, private val itemClickListener: (Int) -> Unit) :
    RecyclerView.Adapter<WelcomFragmentAdapter.VH>() {
    ...
    class VH(val binding: ItemTariffBinding, val context: Context)
