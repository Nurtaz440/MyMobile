...
class MinutsToMbAdapter(val context: Context,private val itemClickListener: (Int) -> (Unit)) :
    RecyclerView.Adapter<MinutsToMbAdapter.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        val isVisible:Boolean=arrayList[position].expanded

        holder.cvExpanded.visibility = if (isVisible) {
            View.VISIBLE
