package mening.dasturim.mymobile.ui.main.user.tariff.best
...
import mening.dasturim.mymobile.ui.main.user.tariff.units.UnitsFragmentVM
import mening.dasturim.mymobile.ui.main.user.tariff.welcom.WelcomFragmentAdapter
import mening.dasturim.mymobile.utils.ViewUtils

class BestFragment : BaseFragment<FragmentInternetBinding, BestFragmentVM>() {
    private lateinit var rateAdapter: BestFragmentAdapter
    ...
    fun setUp() {
        ...
        list = ArrayList()
        rateAdapter = BestFragmentAdapter(requireContext()) {
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Tariflar").collection("Zo'r")
