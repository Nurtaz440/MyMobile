package mening.dasturim.mymobile.ui.main.user.internet.order
...
class OrderFragment : BaseFragment<FragmentInternetBinding, BestFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Internet paketlar").collection("Buyurtma to‘plam")
