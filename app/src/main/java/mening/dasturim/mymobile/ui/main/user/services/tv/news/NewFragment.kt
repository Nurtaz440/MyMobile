package mening.dasturim.mymobile.ui.main.user.services.tv.news
...
class NewFragment : BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("ozb yangiliklari")
