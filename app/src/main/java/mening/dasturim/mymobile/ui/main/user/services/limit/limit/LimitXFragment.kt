package mening.dasturim.mymobile.ui.main.user.services.limit.limit
...
class LimitXFragment  : BaseFragment<FragmentInternetBinding, LimitXFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("Limitsiz ovoz")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("Men aloqadaman")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Avtoavans")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Boshqa Raqamga yonaltirish")
    ...
    override val vm: LimitXFragmentVM
        get() = ViewModelProvider(this).get(LimitXFragmentVM::class.java)
