package mening.dasturim.mymobile.ui.main.user.services.call.internet
...
class InternetXXXFragment : BaseFragment<FragmentInternetBinding, InternetXXXFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("internet")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("Vada qilingan tolov")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("ivr raqamlar")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Qo'ng'iroq detalizatsiyasi")
    ...
    override val vm: InternetXXXFragmentVM
        get() = ViewModelProvider(this).get(InternetXXXFragmentVM::class.java)
}