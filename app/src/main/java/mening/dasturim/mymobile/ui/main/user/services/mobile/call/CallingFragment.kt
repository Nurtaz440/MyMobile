package mening.dasturim.mymobile.ui.main.user.services.mobile.call
...
class CallingFragment: BaseFragment<FragmentInternetBinding, CallingFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Sizga qo'ng'iroq qilishdi")
    ...
    override val vm: CallingFragmentVM
        get() = ViewModelProvider(this).get(CallingFragmentVM::class.java)
}