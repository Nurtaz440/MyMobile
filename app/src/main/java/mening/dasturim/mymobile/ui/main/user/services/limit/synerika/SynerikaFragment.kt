package mening.dasturim.mymobile.ui.main.user.services.limit.synerika
...
class SynerikaFragment: BaseFragment<FragmentInternetBinding, SynerikaFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("synerika")
    ...
    override val vm: SynerikaFragmentVM
        get() = ViewModelProvider(this).get(SynerikaFragmentVM::class.java)
}