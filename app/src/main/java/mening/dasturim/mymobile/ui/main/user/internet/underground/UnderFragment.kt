package mening.dasturim.mymobile.ui.main.user.internet.underground
...
class UnderFragment : BaseFragment<FragmentInternetBinding, UnderFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Internet paketlar")
                .collection("Oylik internet to'plamlar")
    ...
    override val vm: UnderFragmentVM
        get() = ViewModelProvider(this).get(UnderFragmentVM::class.java)
