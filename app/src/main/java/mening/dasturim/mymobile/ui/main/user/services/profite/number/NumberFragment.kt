package mening.dasturim.mymobile.ui.main.user.services.profite.number
...
class NumberFragment: BaseFragment<FragmentInternetBinding, NumberFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("istalgan raqam")
    ...
    override val vm: NumberFragmentVM
        get() = ViewModelProvider(this).get(NumberFragmentVM::class.java)
}