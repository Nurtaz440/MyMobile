package mening.dasturim.mymobile.ui.main.user.services.call.payment
...
class PaymentFragment: BaseFragment<FragmentInternetBinding, PaymentFragmentVM>() {
  ...
  fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Sirli qo’ng’iroq")
    ...
    override val vm: PaymentFragmentVM
        get() = ViewModelProvider(this).get(PaymentFragmentVM::class.java)
}