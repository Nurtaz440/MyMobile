...
class NonStopFragment : BaseFragment<FragmentInternetBinding,NonStopVM>() {
    ...
    fun setUp(){
        ...
        nonStopAdapter.setData(list)

        binding.rvInternet.layoutManager=
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)

        binding.rvInternet.adapter=nonStopAdapter
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Internet paketlar").collection("Kunlik non stop")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Internet paketlar").collection("Oylik Internet-to'plamlar")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Internet paketlar").collection("Internet-avans")
    ...
    fun getBeeline() {
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Internet paketlar")
                .collection("Oylik Internet paketlar")
