package mening.dasturim.mymobile.ui.main.user.internet.monthly
...
class MonthlFragment  : BaseFragment<FragmentInternetBinding, MonthFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Internet paketlar")
                .collection("Metroda Ucell checksiz internet")
    ...
    override val vm: MonthFragmentVM
        get() = ViewModelProvider(this).get(MonthFragmentVM::class.java)
