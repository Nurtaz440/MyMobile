package mening.dasturim.mymobile.ui.main.user.services.profite.intech
...
class IntechFragment : BaseFragment<FragmentInternetBinding, IntechFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("intech")
    ...
    fun getMobiUz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("IMEI-kodni ro‘yxatdan o‘tkazish")
    ...
    override val vm: IntechFragmentVM
        get() = ViewModelProvider(this).get(IntechFragmentVM::class.java)
}