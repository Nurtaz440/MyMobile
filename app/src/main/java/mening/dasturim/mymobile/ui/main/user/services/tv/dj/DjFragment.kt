package mening.dasturim.mymobile.ui.main.user.services.tv.dj
...
class DjFragment : BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("dj")
