package mening.dasturim.mymobile.ui.main.user.minuts.speak
...
import mening.dasturim.mymobile.ui.main.user.minuts.call.MinutesVM
import mening.dasturim.mymobile.ui.main.user.minuts.call.MinutsAdapter

class SpeakFragment : BaseFragment<FragmentMinutsBinding, SpeakFragmentVM>() {
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Daqiqalar").collection("Gap ko'p")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Daqiqalar").collection("Extra 200")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Daqiqalar").collection("xalqaro qongiroq")
