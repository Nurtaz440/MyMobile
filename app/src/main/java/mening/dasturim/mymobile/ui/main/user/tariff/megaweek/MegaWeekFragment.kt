package mening.dasturim.mymobile.ui.main.user.tariff.megaweek
...
class MegaWeekFragment  : BaseFragment<FragmentInternetBinding, BestFragmentVM>() {
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Tariflar").collection("Mega hafta")
