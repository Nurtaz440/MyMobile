package mening.dasturim.mymobile.ui.main.user.services.profite.kron
...
class KronFragment: BaseFragment<FragmentInternetBinding, KronFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Kron telekom")
  ...
  fun getMobiUz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("Аllplay")
    ...
    fun getUzMobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("Yashirin qo‘ng‘iroq")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("BeeGudok")
    ...
    override val vm: KronFragmentVM
        get() = ViewModelProvider(this).get(KronFragmentVM::class.java)
}