...
class MinutesFragment  : BaseFragment<FragmentMinutsBinding, MinutesVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Daqiqalar").collection("Daqiqalar")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Daqiqalar").collection("Daqiqalar toplami")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Daqiqalar").collection("Qulay daqiqalar")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Daqiqalar").collection("Ko'p So'zla")
