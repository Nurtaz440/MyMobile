package mening.dasturim.mymobile.ui.main.user.services.call.night
...
class CallXFragment  : BaseFragment<FragmentInternetBinding, CallXFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("tungi qo'ng'iroq")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("chaqiriqni boshqa raqamga yonaltirish ")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("lux content")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Samolyot bortida rouming")
    ...
    override val vm: CallXFragmentVM
        get() = ViewModelProvider(this).get(CallXFragmentVM::class.java)
}