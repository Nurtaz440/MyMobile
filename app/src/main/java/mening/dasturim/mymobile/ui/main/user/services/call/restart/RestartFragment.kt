package mening.dasturim.mymobile.ui.main.user.services.call.restart
...
class RestartFragment : BaseFragment<FragmentInternetBinding, RestartFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("Restrat")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("Raqamni tiklash ")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("sms imzo")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("O'zimning raqamlarim")
    ...
    override val vm: RestartFragmentVM
        get() = ViewModelProvider(this).get(RestartFragmentVM::class.java)
}