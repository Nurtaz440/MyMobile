package mening.dasturim.mymobile.ui.main.user.services.test.sms
...
class SurkhandariyoFragment : BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Surxandariyo vil sms")
