package mening.dasturim.mymobile.ui.main.user.services.family.support
...
class SupportFragment : BaseFragment<FragmentInternetBinding, SupportFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("Qollab yubor")
  ...
  fun getMobiUz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("iTV’dan Mobil TV")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Turist S")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Raqamni blokirovka qilish")
    ...
    override val vm: SupportFragmentVM
        get() = ViewModelProvider(this).get(SupportFragmentVM::class.java)
}