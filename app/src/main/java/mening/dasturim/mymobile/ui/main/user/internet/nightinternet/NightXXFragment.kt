package mening.dasturim.mymobile.ui.main.user.internet.nightinternet
...
class NightXXFragment  : BaseFragment<FragmentInternetBinding, NightXXFragmentVM>() {
    ...
    override val vm: NightXXFragmentVM
        get() = ViewModelProvider(this).get(NightXXFragmentVM::class.java)
