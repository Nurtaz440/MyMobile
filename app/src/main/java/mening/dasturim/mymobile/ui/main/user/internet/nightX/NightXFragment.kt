...
import mening.dasturim.mymobile.ui.main.user.internet.nightX.NightXFragmentVM
import mening.dasturim.mymobile.ui.main.user.internet.megaboom.MegaBoomAdapter


class NightXFragment: BaseFragment<FragmentInternetBinding, NightXFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Internet paketlar")
                .collection("Tunda 4Gni sinab ko'r")
    ...
    override val vm: NightXFragmentVM
        get() = ViewModelProvider(this).get(NightXFragmentVM::class.java)
