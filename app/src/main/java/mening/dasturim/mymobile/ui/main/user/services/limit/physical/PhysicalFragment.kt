package mening.dasturim.mymobile.ui.main.user.services.limit.physical
...
class PhysicalFragment: BaseFragment<FragmentInternetBinding, PhysicalFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Jismoniy shaxslar uchun sug'urta")
  ...
  fun getMobiUz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("Mening yangi raqamim")
  ...
  fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Do it!")
    ...
    override val vm: PhysicalFragmentVM
        get() = ViewModelProvider(this).get(PhysicalFragmentVM::class.java)
}