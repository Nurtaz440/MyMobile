...
class DailyAdapter(private val itemClickListener: (Int) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        val binding =
            DataBindingUtil.inflate<ItemDailyStopBinding>(inflater, R.layout.item_daily_stop,parent,false)
    ...
    class VH(private val binding: ItemDailyStopBinding, private val context: Context)
        ...
        fun onBind(rate : DailyItems){
            binding.apply {
                ...
                tvDailyName.setText(rate.name)
                tvDailyName2.setText(rate.name)
                tvDailyAbonent.setText(rate.abonent)
                tvDailyInternet.setText(rate.internet)
