package mening.dasturim.mymobile.ui.main.user.services.family.ziyonet
...
class ZiyoFragment : BaseFragment<FragmentInternetBinding, ZiyoFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("ziyonet")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("XR ulanish")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Kombo")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Raqamni aniqlash")
    ...
    override val vm: ZiyoFragmentVM
        get() = ViewModelProvider(this).get(ZiyoFragmentVM::class.java)
}