package mening.dasturim.mymobile.ui.main.user.services.test.vas
...
class VasFragment: BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Vas services")
