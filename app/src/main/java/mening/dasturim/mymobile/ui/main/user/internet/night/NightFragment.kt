package mening.dasturim.mymobile.ui.main.user.internet.night
...
class NightFragment: BaseFragment<FragmentInternetBinding, NightFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Internet paketlar")
                .collection("Tungi Internet-to'plamlar")
    ...
    override val vm: NightFragmentVM
        get() = ViewModelProvider(this).get(NightFragmentVM::class.java)
