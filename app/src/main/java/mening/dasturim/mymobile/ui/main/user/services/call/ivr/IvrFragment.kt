package mening.dasturim.mymobile.ui.main.user.services.call.ivr
...
class IvrFragment : BaseFragment<FragmentInternetBinding, IvrFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("muddatli tolov")
  ...
  fun getMobiUz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("Menga qo’ng’iroq qil!")
  ...
  fun getUzMobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("Shaxsiy raqam uzatilishini taqiqlash")
  ...
  fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Fantasy Football")
    ...
    override val vm: IvrFragmentVM
        get() = ViewModelProvider(this).get(IvrFragmentVM::class.java)
}