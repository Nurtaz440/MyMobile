package mening.dasturim.mymobile.ui.main.user.internet.byhours
...
class HoursFragment: BaseFragment<FragmentInternetBinding, HoursFragmentVM>() {
    ...
    override val vm: HoursFragmentVM
        get() = ViewModelProvider(this).get(HoursFragmentVM::class.java)
