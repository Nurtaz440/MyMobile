package mening.dasturim.mymobile.ui.main.user.services.test.dixanet
...
class DixanetFragment : BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("dixanet sys")
