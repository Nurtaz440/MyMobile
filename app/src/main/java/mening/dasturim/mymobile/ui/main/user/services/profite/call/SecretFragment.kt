package mening.dasturim.mymobile.ui.main.user.services.profite.call
...
class SecretFragment: BaseFragment<FragmentInternetBinding, SecretFragmentVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Maxfiy qo'ng'iroq")
  ...
  fun getUzMobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("Yaqinlaringizga paket xarid qiling")
    ...
    override val vm: SecretFragmentVM
        get() = ViewModelProvider(this).get(SecretFragmentVM::class.java)
}