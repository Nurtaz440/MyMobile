package mening.dasturim.mymobile.ui.main.user.services.family.penalty
...
class PenaltyFragment : BaseFragment<FragmentInternetBinding, PenaltyFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("muzzone")
 ...
 fun getMobiUz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("AntiAON")
   ...
   fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Qadamlar uchun giglar")
    ...
    override val vm: PenaltyFragmentVM
        get() = ViewModelProvider(this).get(PenaltyFragmentVM::class.java)
}