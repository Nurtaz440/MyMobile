...
class MobileFragment : BaseFragment<FragmentInternetPocketsBinding, MobileFragmentVM>() {
    private lateinit var firebaseFirestore: FirebaseFirestore
    lateinit var profiteAdapter: MobileFragmentVP
    override fun onBound() {
        setUp()
    }
    fun setUp(){
        ViewUtils.fadeIn(binding.progressBar)
        profiteAdapter= MobileFragmentVP(requireFragmentManager(),requireActivity().lifecycle)
                                    ...
                                    if (p0.isSuccessful) {
                                        ...
                                        p0.result?.let {
                                            ...
                                            val list: List<String> =
                                                it.get("collections5") as ArrayList<String>
    ...
    override val vm: MobileFragmentVM
        get() = ViewModelProvider(this).get(MobileFragmentVM::class.java)
}