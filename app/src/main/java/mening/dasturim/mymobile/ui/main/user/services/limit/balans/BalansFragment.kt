package mening.dasturim.mymobile.ui.main.user.services.limit.balans
...
class BalansFragment  : BaseFragment<FragmentInternetBinding, BalansFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("extra balans")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("Raqamni saqlab turish")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Hisob kitob")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Meni hisobimni to'ldirip qo'y")
    ...
    override val vm: BalansFragmentVM
        get() = ViewModelProvider(this).get(BalansFragmentVM::class.java)
}