package mening.dasturim.mymobile.ui.main.user.services.test.close
...
class CloseFragment : BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Xizmatlarni o'chirish")
