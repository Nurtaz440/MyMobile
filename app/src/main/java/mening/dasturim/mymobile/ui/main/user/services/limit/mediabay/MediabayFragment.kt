package mening.dasturim.mymobile.ui.main.user.services.limit.mediabay
...
class MediabayFragment  : BaseFragment<FragmentInternetBinding, MediabayFragmentVM>() {
    ...
    fun getUzmobile(){
        val query: Query =
            firebaseFirestore.collection("UzMobile").document("Xizmatlar").collection("Mediabay")
    ...
    fun getMobiuz(){
        val query: Query =
            firebaseFirestore.collection("MobiUz").document("Xizmatlar").collection("Raqamni almashtirish")
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("Bolalar uchun")
    ...
    fun getBeeline(){
        val query: Query =
            firebaseFirestore.collection("Beeline").document("Xizmatlar").collection("Menga qo'ng'iroq qil")
    ...
    override val vm: MediabayFragmentVM
        get() = ViewModelProvider(this).get(MediabayFragmentVM::class.java)
