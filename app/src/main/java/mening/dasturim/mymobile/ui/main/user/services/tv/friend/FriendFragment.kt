package mening.dasturim.mymobile.ui.main.user.services.tv.friend
...
class FriendFragment : BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("dostim hisobidan sms")
