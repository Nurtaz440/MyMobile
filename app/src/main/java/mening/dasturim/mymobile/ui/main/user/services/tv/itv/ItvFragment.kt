package mening.dasturim.mymobile.ui.main.user.services.tv.itv
...
class ItvFragment : BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("iTV")
