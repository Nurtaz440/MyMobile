package mening.dasturim.mymobile.ui.main.user.services.test.behamer
...
class BehamerFrgament: BaseFragment<FragmentInternetBinding, MbUzbVM>() {
    ...
    fun getUcell(){
        val query: Query =
            firebaseFirestore.collection("Ucell").document("Xizmatlar").collection("behamer")
